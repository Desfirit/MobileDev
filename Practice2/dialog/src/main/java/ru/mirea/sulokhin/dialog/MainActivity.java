...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShowDialog(View view)
    {
        ...
        dialogFragment.show(getSupportFragmentManager(), "mger");
    }
